...
# 2. DATA
# =========================================
bbs <- read.csv("E:/TFM_gangas/GPS/ExtractedV.4/BBS_pseudoabsences_Random_env.csv")
pts <- read.csv("E:/TFM_gangas/GPS/ExtractedV.4/PTS_pseudoabsences_Random_env.csv")
...
# =========================================
ggsave(
  "E:/TFM_gangas/distribution_map.png",
  plot = map_plot,
  width = 8,
  height = 6,
  dpi = 300,
